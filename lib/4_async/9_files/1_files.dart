...
Future<void> main() async {
  var file = File('lib/4_async/9_files/files/file.txt');
  ...
  //
  var file2 = File('lib//4_async/9_files/files/file2.txt');
  ...
  // file2.writeAsStringSync('Carlos teste');

  // Escrevendo várias vezes no arquivo (listas)
  var listaNomes = ['Carlos', 'Cristiane', 'Monica', 'José'];
  var file3 = File('lib//4_async/9_files/files/file3.txt');
