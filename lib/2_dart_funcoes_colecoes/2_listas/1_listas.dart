void main() {
  ...
  // Any
  final listaBusca = ['Carlos', 'Cristiane', 'Oliveira'];
  if (listaBusca.any((nome) => nome == 'Carlos')) {
    print('Tem Carlos');
  }

  // Every
  final listaBusca2 = ['Oliveira', 'Carlos', 'João'];
  ...
  var listaNomesOrdenacao = ['Carlos', 'João', 'José'];
